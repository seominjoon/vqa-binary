...
python prepro_questions.py train #train/question.json train/multiple_choice.json train/answer.json train
...
python prepro_questions.py val --vocab_dict_path train/vocab_dict.json #val/question.json val/multiple_choice.json val/answer.json
